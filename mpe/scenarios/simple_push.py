import numpy as np
from mindspore_rl.environment.mpe.multiagent.core import World, Agent, Landmark
from mindspore_rl.environment.mpe.multiagent.scenario import BaseScenario
